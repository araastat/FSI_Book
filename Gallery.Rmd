...
---
class: middle
```{r Gallery-1, fig.align='center', echo=F}
library(ggpubr)
data("ToothGrowth")
df <- ToothGrowth
...
---
class: middle
```{r Gallery-2, echo = F, fig.align = 'center'}
...
---
class: middle
```{r Gallery-3, echo = F, fig.align="center"}
# library
library(ggridges)
library(ggplot2)
...
.middle[
```{r Gallery-4, echo = F, out.height="500px", fig.align='center'}
library(choroplethr)
data(df_pop_county)
...
```{r Gallery-5,  echo=F, fig.align='center', out.height="500px"}
library(plotly)
...
.middle[
```{r Gallery-6, echo=F, out.height="400px" }
library(dygraphs)
